...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Product.itemCode'
        db.add_column('coopshop_product', 'itemCode',
                      self.gf('django.db.models.fields.CharField')(max_length=32, unique=True, null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Product.itemCode'
        db.delete_column('coopshop_product', 'itemCode')
    ...
    models = {
        ...
        'coopshop.product': {
            ...
            'itemCode': ('django.db.models.fields.CharField', [], {'max_length': '32', 'unique': 'True', 'null': 'True', 'blank': 'True'}),
