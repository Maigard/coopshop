...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Order.paymentType'
        db.add_column('coopshop_order', 'paymentType',
                      self.gf('django.db.models.fields.CharField')(max_length=16, null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Order.paymentType'
        db.delete_column('coopshop_order', 'paymentType')
    ...
    models = {
        ...
        'coopshop.order': {
            ...
            'paymentType': ('django.db.models.fields.CharField', [], {'max_length': '16', 'null': 'True', 'blank': 'True'}),
        ...
        'coopshop.orderitem': {
            'Meta': {'ordering': "['product__producer']", 'object_name': 'OrderItem'},
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
